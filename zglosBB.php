  ...
  while ($wiersz = mysql_fetch_row($idzapytania)) 
   {
    ...
    if ($id_wys > 11999) {
     ...
     $zapyt1 = "SELECT Kolarze.id_kol, Kolarze.nazw FROM Kolarze INNER JOIN ktopoj ON Kolarze.id_kol=ktopoj.id_kol WHERE Kolarze.id_user=\"".$idek."\" AND ktopoj.id_wys=\"".$id_wys."\" AND Kolarze.id_user > 0";
     ...
     while ($wiersz = mysql_fetch_row($idzapyt1)) 
     {
      ...
      $zapyt2 = "INSERT INTO zgloszenia (id_zgl, kolej, id_kol, id_wys, id_user, pri, dataZ) VALUES ('$idzg', '$i', '$wiersz[0]', '$id_wys', '$idek', '$prio', '$datka')";
      $idzapyt2 = mysql_query($zapyt2) or die('mysql_query');
      echo $zapyt2,"<br/><br/>";
      $i = $i + 1;
