  ...
  while ($wiersz = mysql_fetch_row($idzapytania)) 
   {
    ...
    echo poczatek();
        ...
        echo '<table class="wyscig">';
       	$sql = " SELECT dok , dataP , dataK FROM wydarzenia ORDER BY dataP ";
       	$zap = mysql_query($sql) or die('mysql_query');
       	echo '<tr><td>Wydarzenie</td><td> data początku </td><td> data końca </td></tr>';
        while ($dane = mysql_fetch_row($zap))
        {
          echo '<tr><td class="wyscig7">'.$dane[0].'</td><td class="wyscig6">'.$dane[1].'</td><td class="wyscig6">'.$dane[2].'</td></tr>';
        }
