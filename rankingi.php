  ...
  while ($wiersz = mysql_fetch_row($idzapytania)) 
   {
    ...
    echo  '<form action="rankingi.php" method="GET">';
    ...
    if ($sort1 == 2) 
		  ...
		  {
		    $sql = " SELECT Kolarze.id_kol, Kolarze.imie, Kolarze.nazw, Nat.flaga, Nat.nazwa, z_ranking2.Cli, z_ranking2.Hil, z_ranking2.Fl, z_ranking2.Spr, z_ranking2.Cbl, z_ranking2.TT, Ekipy.nazwa, Kolarze.id_user "
