  ...
  while ($wiersz = mysql_fetch_row($idzapytania)) 
   {
    ...
    echo poczatek();
	  ...
	  echo '<tr><td>'.$roczek.' rok</td><td class="wyscig3">  </td><td>'.$roczek1.' rok</td></tr> ';
	  echo '<tr><td>';
	  ...
	  //  historia kolarza  /
	  //--------------------/
	  echo '<h2>historia kolarza</h2>';
	  $sqlhis = " SELECT id_kol, id_z, id_do, kiedy, YEAR(kiedy) "
	  ...
	  while ($danhis = mysql_fetch_row($zaphis))
	  {
	    ...
	    echo '<tr><td>',$danhise[0],' <img src="img/flagi/'.$danhise[4].'" alt="flaga" /> ('.$danhise[2].') - '.$danhise[3].'</td><td>',$danhis[3],'</td></tr>';
          }
	  echo '
                </table>';
