...
<head>
   ...
   <title>SKARB KIBICA - <?php echo zwroc_tekst(15, $jezyk); ?></title>
</head>
<body>
...
?>
	  ...
	  echo '<h1>'.zwroc_tekst(15, $jezyk).'</h1>';
	  
	  
	   $sort1 = $_GET['sort'];
           if ($sort1 == "") {$sort1 = 1;}

           echo  '<form action="rankingikro.php" method="GET">';
    ...
    if ($sort1 == 2) 
		  ...
		  {
		    $sql = " SELECT Kolarze.id_kol, Kolarze.imie, Kolarze.nazw, Nat.flaga, Nat.nazwa, z_ranking.Cli, z_ranking.Hil, z_ranking.Fl, z_ranking.Spr, z_ranking.Cbl, z_ranking.TT, Ekipy.nazwa, Kolarze.id_user, Kolarze.id_team "
    ...
    if ($i == $_GET['zazn'])  {
      ...
      <b><a href="kol.php?id_kol='.$dane[0].'">'.$dane[1].' '.$dane[2].'</a><br/>';
