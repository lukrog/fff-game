...
?>
	  ...
	  <a href="wyscig.php?id_wys='.$id_wys.'">'.zwroc_tekst(123, $jezyk).'</a>
	  '; 
	...
	//	 ORDER BY Wyniki.miejsce, Wyniki.wynik, Wyniki.id_wyn ";
		 
	      $zap = " SELECT Wyniki.id_wyn, Wyniki.miejsce, Kolarze.imie, Kolarze.nazw, Nat.nazwa , Nat.flaga , Ekipy.nazwa , Ekipy.nazwa, Kolarze.id_team, Kolarze.id_nat, Kolarze.id_kol, Wyniki.punkty, Ekipy.nazwa, Wyniki.wynik 
	               FROM Ekipy, Nat, Kolarze, Wyniki
		       WHERE Wyniki.id_co = '$teraz_omawiane' AND Wyniki.id_wys= '$id_wys' AND Kolarze.id_kol = Wyniki.id_kol AND Nat.id_nat = Kolarze.id_nat AND Ekipy.id_team = Kolarze.id_team 
	               ORDER BY Wyniki.miejsce, Wyniki.wynik, Wyniki.id_wyn ";	 
	...
	//	 ORDER BY WynikiP.miejsce, WynikiP.wynik, WynikiP.id_wyn ";  
		 
	      $zap = " SELECT WynikiP.id_wyn, WynikiP.miejsce, Kolarze.imie, Kolarze.nazw, Nat.nazwa , Nat.flaga , Ekipy.nazwa , Ekipy.nazwa, Kolarze.id_team, Kolarze.id_nat, Kolarze.id_kol, WynikiP.punkty, Ekipy.nazwa, WynikiP.wynik 
	               FROM Ekipy, Nat, Kolarze, WynikiP
		       WHERE WynikiP.id_co = '$teraz_omawiane' AND WynikiP.id_wys= '$id_wys' AND Kolarze.id_kol = WynikiP.id_kol AND Nat.id_nat = Kolarze.id_nat AND Ekipy.id_team = Kolarze.id_team
		       ORDER BY WynikiP.miejsce, WynikiP.wynik, WynikiP.id_wyn ";	     
            }
	    ...
	    $num_rows = mysql_num_rows($idz); 
		 ...
		 $sqlhise = " SELECT z_a_historiaekip.nazwa, z_a_historiaekip.id_nat, z_a_historiaekip.skr, z_a_historiaekip.dyw, Nat.flaga, z_a_historiaekip.id_ek 
		              ...
		              WHERE (z_a_historiaekip.id_ek = '$danhis[0]') AND (z_a_historiaekip.rok = '$danhis[2]') AND z_a_historiaekip.id_nat = Nat.id_nat ";             
