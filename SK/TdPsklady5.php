	   ...
	   echo '<pre>
{
  "team": {
    ...
    "flag": "'.$dane_ek[3].'",
    "color": "#8b8178",
    "tshirt": "http://tourdepologne.pl/wp-content/uploads/'.$rok_dziś.'/ekipy/tshirt.jpg",
    "logo": "http://tourdepologne.pl/wp-content/uploads/'.$rok_dziś.'/ekipy/logo.jpg",
    "photo": "http://tourdepologne.pl/wp-content/uploads/'.$rok_dziś.'/ekipy/photo.jpg"
  },
  "profiles": [';
  ...
  $sql_ekipa = "SELECT `id_kol`, `nr_st` FROM `z_z_zTdP` WHERE `id_ekipy`= '$id_ek' LIMIT 0, 7";
      ...
      echo '
    {
      ...
      "age": '.$wiek.',
      "photo": "http://www.tourdepologne.pl/wp-content/uploads/'.$rok_dziś.'/zawodnicy/'.$startowynr.'.png",
      "achievements": [
         {
           ';
      //tu osiągnięcia
