...
<table id="glowna">
  ...
  <tr>
    <td class="podgoraSK" colspan="3" align="left">
    <!--  góra + logowanie-->
...
';
	  ...
	  echo '<tr><td>ranking kroczący</td><td class="wyscig3">  </td><td>bierzący rok</td></tr> ';
	  echo '<tr><td>';
...
echo '       </td>
 ...
 <tr>
    <td class="dolSK" colspan="3">Done by BigBird (R)
    </td>
    </tr>
    </table>
    </div>
